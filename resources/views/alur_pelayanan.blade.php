...
<div class="max-w-7xl mx-auto px-6 lg:px-8 py-16">
    ...
    <div class="text-center mb-20">
        ...
        <p class="text-soft-teal max-w-2xl mx-auto text-base md:text-lg font-medium">
            Proses skrining cerdas dan pendampingan kesehatan mental yang mudah, aman, dan terstruktur.
        </p>
    </div>
    ...
    <div class="relative wrap overflow-hidden p-4 h-full mb-24">
        ...
        <div class="mb-12 flex justify-between flex-row-reverse md:flex-row items-center w-full">
            <div class="w-full md:w-5/12 bg-white rounded-[24px] shadow-xl shadow-deep-teal/5 p-8 border border-mint-soft/10">
                <div class="flex justify-between items-start mb-4">
                    <h3 class="font-extrabold text-deep-teal text-xl">1. Skrining & Profiling</h3>
                ...
                <p class="text-sm text-[#5F6F6D] leading-relaxed font-medium">
                    Mahasiswa melengkapi data demografi akademik dan mengisi kuesioner indikasi gejala yang diadaptasi langsung dari instrumen standar klinis global global (PHQ-9 & GAD-7) dalam rentang waktu 2 minggu terakhir.
                </p>
            </div>
        ...
        <div class="mb-12 flex justify-between items-center w-full">
            ...
            <div class="w-full md:w-5/12 bg-white rounded-[24px] shadow-xl shadow-deep-teal/5 p-8 border border-mint-soft/10">
                <div class="flex justify-between items-start mb-4 md:flex-row-reverse">
                    <h3 class="font-extrabold text-deep-teal text-xl md:text-right w-full">2. Kombinasi Pakar & Risiko</h3>
                ...
                <p class="text-sm text-[#5F6F6D] leading-relaxed font-medium md:text-right">
                    Mesin inferensi Certainty Factor (CF) bekerja di latar belakang, mengawinkan derajat keyakinan mahasiswa dengan bobot klinis pakar, serta mengombinasikannya dengan variabel stresor lingkungan (seperti IPK dan tingkat tahun kuliah).
                </p>
            </div>
        </div>
        ...
        <div class="mb-12 flex justify-between flex-row-reverse md:flex-row items-center w-full">
            <div class="w-full md:w-5/12 bg-white rounded-[24px] shadow-xl shadow-deep-teal/5 p-8 border border-mint-soft/10">
                <div class="flex justify-between items-start mb-4">
                    <h3 class="font-extrabold text-deep-teal text-xl">3. Penentuan Triase Akhir</h3>
                ...
                <p class="text-sm text-[#5F6F6D] leading-relaxed font-medium">
                    Sistem mengalkulasi skor urgensi global (0% - 100%) untuk memetakan kategori masalah yang paling dominan tanpa menampilkan label diagnosis medis langsung kepada mahasiswa demi menjaga kenyamanan psikologis.
                </p>
            </div>
        ...
        <div class="mb-12 flex justify-between items-center w-full">
            ...
            <div class="w-full md:w-5/12 bg-white rounded-[24px] shadow-xl shadow-deep-teal/5 p-8 border border-mint-soft/10">
                <div class="flex justify-between items-start mb-4 md:flex-row-reverse">
                    <h3 class="font-extrabold text-deep-teal text-xl md:text-right w-full">4. Prioritas Intervensi</h3>
                    <div class="p-3 bg-mint-soft/10 rounded-xl text-soft-teal md:mr-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p class="text-sm text-[#5F6F6D] leading-relaxed font-medium md:text-right">
                    Konselor/Psikolog kampus menerima data antrean mahasiswa yang otomatis diurutkan secara real-time dari skor urgensi tertinggi, memungkinkan penanganan penanganan dini (*early intervention*) yang tepat sasaran.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-[32px] p-8 md:p-12 shadow-xl shadow-deep-teal/5 border border-mint-soft/20">
        <div class="text-center mb-10">
            ...
            <p class="text-[#5F6F6D] text-sm md:text-base leading-relaxed max-w-4xl mx-auto font-medium">
                Certainty Factor adalah metode pengolahan ketidakpastian matematis yang digunakan oleh sistem pakar Senandika untuk menghitung derajat kepastian atau tingkat urgensi kondisi emosional berdasarkan akumulasi konfirmasi gejala klinis dan parameter lingkungan akademik.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-cream/40 rounded-2xl p-6 border border-mint-soft/10">
                <h4 class="font-extrabold text-deep-teal text-base mb-4 flex items-center gap-2">
                    <span class="w-2.5 h-2.5 rounded-full bg-soft-orange"></span> Keunggulan Analisis Multi-Aspek
                </h4>
                <ul class="space-y-3 text-sm text-[#5F6F6D] font-medium">
                    <li class="flex items-start gap-2"><span class="text-soft-orange font-bold">•</span> Mengakomodasi fleksibilitas ambiguitas perasaan manusia secara objektif.</li>
                    <li class="flex items-start gap-2"><span class="text-soft-orange font-bold">•</span> Mengintegrasikan gejala psikologis internal dengan stressor eksternal lingkungan (IPK & Tahun Kuliah).</li>
                    <li class="flex items-start gap-2"><span class="text-soft-orange font-bold">•</span> Memberikan kalkulasi pembobotan berlapis yang divalidasi oleh teori referensi klinis global.</li>
                </ul>
            </div>
            ...
            <div class="bg-cream/40 rounded-2xl p-6 border border-mint-soft/10">
                ...
                <div class="grid grid-cols-2 gap-2 text-xs text-[#5F6F6D] font-bold">
                    ...
                    <div class="bg-white p-3 rounded-xl border border-mint-soft/10 flex items-center">Beberapa Hari (0.4)</div>
                    <div class="bg-white p-3 rounded-xl border border-mint-soft/10 flex items-center">Lebih Dari Separuh Waktu (0.8)</div>
                    <div class="bg-gradient-to-r from-deep-teal to-soft-teal text-white p-3 rounded-xl text-center shadow-md flex items-center justify-center font-bold">Hampir Setiap Hari (1.0)</div>
                </div>
            </div>
        </div>
    </div>
